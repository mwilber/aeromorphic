<?php
	...
	$listTitle = "Aeromorphic";

	$social = array();
	$social['title'] = "Aeromorphic";
	$social['message'] = "INSERTSHORTMESSAGE";
	$social['description'] = "INSERTDESCRIPTION";
	$social['image'] = "http://www.aeromorphic.com/img/fb_icon.png";
	$social['link'] = "http://www.aeromorphic.com".$_SERVER[REQUEST_URI];
...
<div class="container modal">
	<div class="wrap">
		...
		<div id="telescreen">
			<!--<img class="vport" src=""/>-->
			<canvas id="sky" width="1024" height="1024">
				alternate content
			</canvas>
		</div>
	</div>
...
<script src="js/cCloudArtist.js"></script>
